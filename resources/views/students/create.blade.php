                ...
                <div class="card-body p-4 p-md-5">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3 mb-4">
                        <div>
                            ...
                            <p class="text-muted small mb-0">Fill in student details to register a new student.</p>
                        </div>
                    ...
                    <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="department_id" class="form-select" required>
                                    ...
                                    @foreach($departments as $department)
                                        <option value="{{ $department->id }}" {{ old('department_id') == $department->id ? 'selected' : '' }}>{{ $department->department_name }} ({{ $department->department_code }})</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mt-4 d-flex flex-wrap gap-2">
                            ...
                            <a href="{{ route('students.index') }}" class="btn btn-soft-primary">Back</a>
                        </div>
                    </form>
                </div>
            </section>
